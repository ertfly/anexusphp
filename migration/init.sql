...
-- app_authfast definition

-- Drop table

-- DROP TABLE app_authfast;

CREATE TABLE app_authfast (
	id int2 NOT NULL GENERATED BY DEFAULT AS IDENTITY,
	app_id int2 NOT NULL,
	authfast_id int2 NOT NULL,
	CONSTRAINT pk_app_authfast PRIMARY KEY (id)
);
